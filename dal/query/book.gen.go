...
type IBookDo interface {
	...
	FilterWriteColumn(column string, value string) (result []*model.Book, err error)
	Search(book *model.Book) (result []*model.Book, err error)
}
...
func (b bookDo) FilterWriteColumn(column string, value string) (result []*model.Book, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, value)
	generateSQL.WriteString("select * from book where " + b.Quote(column) + "=? ")
...
// {{end}}
// {{end}}
func (b bookDo) Search(book *model.Book) (result []*model.Book, err error) {
	var params []interface{}
